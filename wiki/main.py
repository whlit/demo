...
from db import save as save2db
from es import save as save2es
...
if __name__ == "__main__":
    ...
    parseFile('D:/work/demo/python/wiki/.tmp/zhwiki-latest-pages-articles.xml', lambda page: save2es(page))
    pass
